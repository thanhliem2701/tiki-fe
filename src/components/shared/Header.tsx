...
import DeliveryLocation from '../shared/DeliveryLocation'
...
export const Header = () => {
  ...
  const handleGoogleLogin = () => {
    const left = window.screenX + (window.innerWidth - 500) / 2;
